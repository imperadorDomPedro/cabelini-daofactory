...
import br.com.cabelini.daofactory.model.Email;

/**
 * Interface que determina a classe genérica de entidade da classe <code>Email</code> 
 ...
 * @version 1.0 $ 2015
 */
public interface EmailDAO extends CrudDAO<Email, Long> { }
