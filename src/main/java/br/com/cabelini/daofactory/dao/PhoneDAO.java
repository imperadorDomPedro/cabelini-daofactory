...
import br.com.cabelini.daofactory.model.Phone;

/**
 * Interface que determina a classe genérica de entidade da classe <code>Phone</code> 
 ...
 * @version 1.0 $ 2015
 */
public interface PhoneDAO extends CrudDAO<Phone, Long> { }
